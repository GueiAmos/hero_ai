export const translations = {
  fr: {
    ...
    landingDescription: "Transforme ton nom et un mot secret en une aventure extraordinaire générée par l'IA. Des histoires uniques, des illustrations magnifiques, le tout en quelques secondes.",
  ...
  en: {
    ...
    landingDescription: "Transform your name and a secret word into an extraordinary AI-generated adventure. Unique stories, beautiful illustrations, all in seconds.",
