...
import { Download, RotateCcw, BookOpen, Sparkles, FileDown, Plus } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center gap-4 mb-6">
            <div className="p-3 bg-gradient-to-r from-blue-500 via-blue-500 to-orange-500 rounded-2xl shadow-lg">
        ...
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden border border-slate-200">
          {/* Story Header */}
          <div className="bg-gradient-to-r from-blue-600 via-blue-500 to-orange-500 p-6 text-white">
          ...
          <div className="lg:flex lg:min-h-[600px]">
            ...
            <div className="lg:w-1/2 p-8 bg-gradient-to-br from-blue-50 to-blue-100 flex flex-col">
          ...
          {/* Action Buttons */}
          <div className="p-8 bg-gradient-to-r from-blue-50 via-blue-50 to-orange-50 border-t border-slate-200">
            <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-2xl mx-auto">
              <button
                onClick={handleDownloadPDF}
                className="flex-1 bg-gradient-to-r from-blue-600 via-blue-500 to-orange-500 hover:from-blue-700 hover:via-blue-600 hover:to-orange-600 text-white font-bold py-4 px-8 rounded-2xl transition-all duration-300 transform hover:scale-105 hover:shadow-xl flex items-center justify-center gap-3 text-lg shadow-lg"
              >
                <FileDown size={22} />
                Télécharger PDF
              </button>
              ...
              <button
                onClick={onCreateNew}
                className="flex-1 bg-white hover:bg-slate-50 text-slate-700 font-bold py-4 px-8 rounded-2xl border-2 border-slate-300 hover:border-slate-400 transition-all duration-300 transform hover:scale-105 hover:shadow-lg flex items-center justify-center gap-3 text-lg"
              >
                <Plus size={22} />
                Nouvelle histoire
              </button>
