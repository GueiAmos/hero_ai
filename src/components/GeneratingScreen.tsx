  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-orange-50 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-20">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-48 h-48 bg-gradient-to-r from-blue-100/10 to-orange-100/10 rounded-full animate-spin" style={{ animationDuration: '20s' }}></div>
      </div>

      <div className="text-center relative z-10">
        {/* Animated Logo */}
        <div className="mb-8">
          <div className="relative mx-auto w-32 h-32 bg-white rounded-3xl flex items-center justify-center shadow-2xl border border-slate-200 p-6">
            <img 
              src="/logo.png" 
              alt="Hero AI Logo" 
              className="w-full h-full object-contain animate-pulse"
            />
            <div className="absolute inset-0 bg-gradient-to-r from-blue-500/20 via-blue-500/20 to-orange-500/20 rounded-3xl animate-ping"></div>
          </div>
        </div>
        ...
        <div className="mb-8">
          <div className="flex justify-center space-x-3">
            {[...Array(5)].map((_, i) => (
              <div
                key={i}
                className="w-4 h-4 bg-gradient-to-r from-blue-500 to-orange-500 rounded-full animate-bounce shadow-lg"
        ...
        <div className="text-slate-700 text-center max-w-md mx-auto">
          <h2 className="text-3xl font-bold mb-4 flex items-center justify-center gap-3">
            <Zap size={28} className="animate-spin text-blue-500" />
            {t.generating}{dots}
          </h2>
        ...
        <div className="mt-10 w-80 mx-auto">
          <div className="h-3 bg-slate-200 rounded-full overflow-hidden shadow-inner">
            <div className="h-full bg-gradient-to-r from-blue-500 via-blue-500 to-orange-500 rounded-full animate-pulse shadow-lg"></div>
          </div>
        </div>
      </div>
    </div>
